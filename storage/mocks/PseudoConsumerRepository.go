...
// PseudoConsumerRepository is an autogenerated mock type for the PseudoConsumerRepository type
type PseudoConsumerRepository struct {
	mock.Mock
}

// Delete provides a mock function with given fields: consumer
func (_m *PseudoConsumerRepository) Delete(consumer *data.Consumer) error {
...
func (_m *PseudoConsumerRepository) Get(channelID string, consumerID string) (*data.Consumer, error) {
...
func (_m *PseudoConsumerRepository) GetByID(id string) (*data.Consumer, error) {
	ret := _m.Called(id)
...
func (_m *PseudoConsumerRepository) GetList(channelID string, page *data.Pagination) ([]*data.Consumer, *data.Pagination, error) {
...
func (_m *PseudoConsumerRepository) Store(consumer *data.Consumer) (*data.Consumer, error) {
	ret := _m.Called(consumer)
...
// NewPseudoConsumerRepository creates a new instance of PseudoConsumerRepository. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewPseudoConsumerRepository(t interface {
	mock.TestingT
	Cleanup(func())
}) *PseudoConsumerRepository {
	mock := &PseudoConsumerRepository{}
	mock.Mock.Test(t)
