...
// GetPrioritizedJobsForConsumer provides a mock function with given fields: consumer, jobStatus, page
func (_m *DeliveryJobRepository) GetPrioritizedJobsForConsumer(consumer *data.Consumer, jobStatus data.JobStatus, page *data.Pagination) ([]*data.DeliveryJob, *data.Pagination, error) {
	ret := _m.Called(consumer, jobStatus, page)
