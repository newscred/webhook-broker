...
func (_m *DeliveryJobRepository) GetJobStatusCountsGroupedByConsumer() (map[string]map[string][]*data.StatusCount[data.JobStatus], error) {
	ret := _m.Called()
	...
	var r0 map[string]map[string][]*data.StatusCount[data.JobStatus]
	var r1 error
	if rf, ok := ret.Get(0).(func() (map[string]map[string][]*data.StatusCount[data.JobStatus], error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() map[string]map[string][]*data.StatusCount[data.JobStatus]); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(map[string]map[string][]*data.StatusCount[data.JobStatus])
		}
	}
