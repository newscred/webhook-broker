...
// PseudoChannelRepository is an autogenerated mock type for the PseudoChannelRepository type
type PseudoChannelRepository struct {
	mock.Mock
}

// Get provides a mock function with given fields: channelID
func (_m *PseudoChannelRepository) Get(channelID string) (*data.Channel, error) {
...
func (_m *PseudoChannelRepository) GetList(page *data.Pagination) ([]*data.Channel, *data.Pagination, error) {
	ret := _m.Called(page)
...
func (_m *PseudoChannelRepository) Store(channel *data.Channel) (*data.Channel, error) {
...
// NewPseudoChannelRepository creates a new instance of PseudoChannelRepository. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewPseudoChannelRepository(t interface {
	mock.TestingT
	Cleanup(func())
}) *PseudoChannelRepository {
	mock := &PseudoChannelRepository{}
	mock.Mock.Test(t)
